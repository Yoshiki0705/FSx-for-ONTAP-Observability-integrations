"""FSx for ONTAP EMS event shipper for New Relic.
...
New Relic payload format and endpoint.
...
def _format(events: list[dict[str, Any]]) -> list[dict[str, Any]]:
    """Format normalized EMS events for New Relic.
...
def lambda_handler(event: dict[str, Any], context: Any) -> dict[str, Any]:
    ...
    try:
        ...
        logger.error("Failed to retrieve the license key: %s", str(e))
